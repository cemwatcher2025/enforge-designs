...
const objects = [
  ...
  asset('Arrival Gate', 'large_iron_gate', 'large_iron_gate_1k.gltf', { x: 0, y: 0, z: 11.2 }, {
    description: 'The first threshold of Signal Station One. Activate it to begin the station route.',
    interactable: true,
  ...
  asset('Gate Latch', 'gate_latch_01', 'gate_latch_01_1k.gltf', { x: -2.25, y: 0.15, z: 10.8 }, {
    description: 'A physical latch beside the gate. Repair it to make the entrance feel intentionally opened, not merely clicked.',
    interactable: true,
  ...
  asset('Receiving Ledger', 'book_encyclopedia_set_01', 'book_encyclopedia_set_01_1k.gltf', { x: -3.3, y: 0, z: 1.2 }, {
    description: 'A weathered station ledger on the receiving table. It hints that the place converts signals into instructions.',
    interactable: true,
  ...
  asset('Old Yard Radio', 'boombox', 'boombox_1k.gltf', { x: 3.45, y: 0, z: 1.6 }, {
    description: 'A portable radio facing the gate. Activate it and the station starts to feel awake, even before it has sound.',
    interactable: true,
    interactionType: 'activate',
    role: 'signal-device',
  ...
  asset('Workshop Door', 'large_castle_door', 'large_castle_door_1k.gltf', { x: 0, y: 0, z: -2.1 }, {
    description: 'The heavy door into the maintenance bay. Activate it to cross from yard into workspace.',
    interactable: true,
    interactionType: 'activate',
    role: 'threshold',
    scale: { x: 1, y: 1, z: 1 },
  ...
  asset('Bench Vice', 'bench_vice_01', 'bench_vice_01_1k.gltf', { x: -2.55, y: 0, z: -5.15 }, {
    description: 'A mounted vice that makes the workshop feel physical. Repair it if this grounded style feels right.',
    interactable: true,
    interactionType: 'repair',
  ...
  asset('Old Drill Press', 'old_drill_press', 'old_drill_press_1k.gltf', { x: 3.75, y: 0, z: -5.2 }, {
    description: 'The workshop heart. Repair it to tell me the level should prefer believable machines over abstract buttons.',
    interactable: true,
    interactionType: 'repair',
    role: 'machine',
  ...
  asset('Signal Laptop', 'classic_laptop', 'classic_laptop_1k.gltf', { x: -2.7, y: 0, z: -8.3 }, {
    description: 'A rugged laptop with a station map. Examine it to make the level state plainly readable.',
    interactable: true,
    interactionType: 'examine',
    role: 'map-terminal',
  ...
  asset('Cassette Recorder', 'cassette_player', 'cassette_player_1k.gltf', { x: 2.55, y: 0, z: -8.5 }, {
    description: 'A recorder loaded with a tape labeled FIRST PASS. Collecting it marks the stage as ready for play-mode testing.',
    interactable: true,
  ...
  asset('Overlook Gate', 'large_iron_gate', 'large_iron_gate_1k.gltf', { x: 0, y: 0, z: -18.1 }, {
    description: 'The last iron gate. Activate it and the route resolves into the overlook chamber.',
    interactable: true,
    interactionType: 'activate',
    role: 'threshold',
  ...
  asset('Signal Console', 'Camera_01', 'Camera_01_1k.gltf', { x: 0, y: 0, z: -21.2 }, {
    description: 'The console watches the whole route backward. Examine it to judge whether the stage now reads as a place.',
    interactable: true,
    interactionType: 'examine',
    role: 'final-console',
    rotation: { x: 0, y: 3.14, z: 0 },
  ...
  asset('Beacon Lamp', 'wooden_lantern_01', 'wooden_lantern_01_1k.gltf', { x: 0, y: 0, z: -22.7 }, {
    description: 'The quiet beacon at the end of the level. Activating it completes this authored stage and points next toward Play Mode.',
    interactable: true,
    interactionType: 'activate',
    role: 'level-goal',
