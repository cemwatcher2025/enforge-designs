...
The visual system uses lightweight CSS-built artifact icons for room labels, desktop objects, archive drawers, books, and dream symbols. No external 3D icon package or paid asset source is required.
