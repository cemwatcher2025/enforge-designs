...
- KIM Ambient Awareness has a 60-second startup quiet window. After Analyze starts, small first-minute gate passes can update sensors and memory quietly, but they do not trigger Moondream/GPU captions unless the structural change is large. This prevents baseline settling from producing immediate "man sitting" narration.
